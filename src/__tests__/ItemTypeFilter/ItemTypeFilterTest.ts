...
test('should return more than multiple item types',  () => {throw new Error('Not implemented'); });
...
test('should return map fragments', () => {throw new Error('Not implemented'); });
test('should return breach and timeless splinters', () => {throw new Error('Not implemented'); });
test('should return more than multiple item base', () => {throw new Error('Not implemented'); });
